...
```text
1. 新增 MockRuntimeProvider 骨架
2. 用本地事件生成器模拟 message_delta / tool_call / interrupt / error / done
3. 不挂主链路，先写测试或旁路 demo
...
3. 第四阶段已启动：定义跨 runtime 的 run/event/file/workspace 协议，再接 mock runtime
```
