...
```text
docs/architecture/agent-runtime-model.md
docs/architecture/adapter-contracts.md
```
...
```text
1. 第二阶段 adapter 细拆收尾提交
2. 准备 Agent Runtime Adapter 文档到代码 contract 的下一轮落地
3. 后续如需更换 DeepAgents/OpenCode，再进入第三阶段主链路 adapter 化
```
